...
@csrf_exempt   
def GoogleTodoUpdateDelete(request, socialGoogleTokenId, todo_list, todo_id):
   if request.user.is_authenticated:
      if request.method == 'POST':
         ...
         if socialGoogleToken:
            ...
            response = requests.patch(f'https://tasks.googleapis.com/tasks/v1/lists/{todo_list}/tasks/{todo_id}',
                                      params={
                                         'access_token': access_token,
                                      }, json={
                  "title": title
      ...
      if request.method == 'DELETE':
         ...
         if socialGoogleToken:
            ...
            response = requests.delete(f'https://tasks.googleapis.com/tasks/v1/lists/{todo_list}/tasks/{todo_id}',
                                       params={
                                          'access_token': access_token,
                                       })
